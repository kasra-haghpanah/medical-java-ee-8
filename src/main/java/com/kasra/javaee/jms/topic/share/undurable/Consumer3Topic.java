...
@MessageDriven(
        ...
        //@ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "NewsType = 'Sports3' OR NewsType = 'Opinion3'"),
        @ActivationConfigProperty(propertyName = "clientId", propertyValue = "MyID3"),
        @ActivationConfigProperty(propertyName = "subscriptionName", propertyValue = "MySub3"),
...
public class Consumer3Topic implements MessageListener {
