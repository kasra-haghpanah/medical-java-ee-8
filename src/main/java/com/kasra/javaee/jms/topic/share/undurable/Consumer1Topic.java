...
@MessageDriven(
        ...
        //@ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "NewsType = 'Sports1' OR NewsType = 'Opinion1'"),
        @ActivationConfigProperty(propertyName = "clientId", propertyValue = "MyID1"),
        @ActivationConfigProperty(propertyName = "subscriptionName", propertyValue = "MySub1"),
...
public class Consumer1Topic implements MessageListener {
